...
*/
function addImgRule(writingMode, maxWidth,maxHeight)
{
 //alert('addImgRule :' + maxWidth + " " + maxHeight);
 if(writingMode == "horizontal-tb")
 {
  addCSSRule('div', 'width: auto; height: auto;max-width:100%%;max-height:'+ maxHeight +'px;');
  addCSSRule('img', 'width: auto; height: auto;max-width:' + maxWidth + 'px;max-height:'+ maxHeight +'px;');
  addCSSRule('video', 'width: auto; height: auto;max-width:' + maxWidth + 'px;max-height:'+ maxHeight +'px;');
  //addCSSRule('audio', 'width: auto; height: auto;max-width:100%%;max-height'+ maxHeight +'px;');
  return;
 }

 if(writingMode == "vertical-rl" || writingMode == "vertical-lr")
 {
  addCSSRule('div', 'width: auto; height: auto;max-width:' + maxWidth + 'px;max-height:100%%;');
  addCSSRule('img', 'width: auto; height: auto;max-width:' + maxWidth + 'px;max-height:'+ maxHeight +'px;');
  addCSSRule('video', 'width: auto; height: auto;max-width:' + maxWidth + 'px;max-height:'+ maxHeight +'px;');
  //addCSSRule('audio', 'width: auto; height: auto;max-width:100%%;max-height'+ maxHeight +'px;');
  return;
...
function addHtmlRule(writingMode,width,gap,height,paddingTop,paddingLeft,paddingBtm,paddingRight)
{
	...
	//addImgRule(width, height);
	 addImgRule(writingMode, width, height);
}
...
{
	//alert('selector=' + selector + ', newRule=' + newRule);
